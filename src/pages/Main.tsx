      ...
      <div class="max-w-2xl mx-auto">
        <form onSubmit={props.addGuess}>
          <div class="flex items-center py-2 px-1 bg-neutral-800 rounded-lg">
            <button type="button" onClick={() => navigate("/ranking")} class="inline-flex justify-center p-2 bg-neutral-900 text-white hover:bg-gray-500 rounded-lg cursor-pointer">
